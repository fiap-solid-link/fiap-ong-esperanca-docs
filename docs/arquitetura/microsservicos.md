...
-   :material-shield-account:{ .lg .middle } **fiap-ong-esperanca-identity-api**
    ...
    [:octicons-arrow-right-24: Detalhes](microsservicos/fiap-ong-esperanca-identity-api.md)
...
-   :material-bullhorn:{ .lg .middle } **fiap-ong-esperanca-campanhas-api**
    ...
    [:octicons-arrow-right-24: Detalhes](microsservicos/fiap-ong-esperanca-campanhas-api.md)
...
-   :material-cog-transfer:{ .lg .middle } **fiap-ong-esperanca-worker**
    ...
    [:octicons-arrow-right-24: Detalhes](microsservicos/fiap-ong-esperanca-worker.md)
...
-   :material-transit-connection-variant:{ .lg .middle } **fiap-ong-esperanca-gateway-api**
    ...
    [:octicons-arrow-right-24: Detalhes](microsservicos/fiap-ong-esperanca-gateway-api.md)
